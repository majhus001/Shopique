...
const TrendingProducts = ({ trendingProducts }) => {
  ...
  const trendingproductContainerRefs = useRef({});
  const scrollLeft = (subCategory) => {
    const container = trendingproductContainerRefs.current[subCategory];
    if (container) {
    ...
    <section className="products-section">
      {trendingProducts.length > 0 ? (
        <div className="product-category">
          ...
          >
            <h4 className="products-category-title">Trending Products</h4>
            <span
          ...
          <div className="horizontal-scroll-container">
            ...
            <div
              ...
              ref={(el) =>
                (trendingproductContainerRefs.current["trending"] = el)
              }
            >
